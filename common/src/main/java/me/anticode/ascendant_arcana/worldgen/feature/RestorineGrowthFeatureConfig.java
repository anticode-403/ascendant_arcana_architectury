...
public record RestorineGrowthFeatureConfig(int floorToCeilingSearchRange, IntProvider width, FloatProvider radiusToHeightRatio, float ceilingPercentage, float restorine_percentage, boolean netherrack) implements FeatureConfiguration {
    public static final Codec<RestorineGrowthFeatureConfig> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    ...
                    Codec.BOOL.fieldOf("netherrack").orElse(false).forGetter(RestorineGrowthFeatureConfig::netherrack))
