...
public class AArcanaEnchantments {
    ...
    public static RegistrySupplier<Enchantment> GLACIOCLASM = register(new Glacioclasm(), "glacioclasm");
    ...
    public static RegistrySupplier<Enchantment> JOLTING = register(new Jolting(), "jolting");
