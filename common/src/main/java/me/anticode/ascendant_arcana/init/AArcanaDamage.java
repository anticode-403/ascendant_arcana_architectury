...
public class AArcanaDamage {
    ...
    public static final ResourceKey<DamageType> GLACIOCLASM = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.tryBuild(AscendantArcana.MOD_ID, "glacioclasm"));
