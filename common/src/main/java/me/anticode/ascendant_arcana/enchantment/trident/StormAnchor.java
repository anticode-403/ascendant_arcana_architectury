...
public class StormAnchor extends Enchantment {
    public StormAnchor() {
    ...
    protected boolean checkCompatibility(Enchantment other) {
        return super.checkCompatibility(other) && !(other instanceof TridentRiptideEnchantment) && !(other instanceof Sundering) && !(other instanceof Lifetide) && !(other instanceof Singularity);
    }
}
