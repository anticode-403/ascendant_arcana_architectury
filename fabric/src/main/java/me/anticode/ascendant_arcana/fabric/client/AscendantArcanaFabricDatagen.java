...
public class AscendantArcanaFabricDatagen implements DataGeneratorEntrypoint {
    ...
    public static class AALanguageProvider extends FabricLanguageProvider {
        ...
        public void generateTranslations(TranslationBuilder translationBuilder) {
            ...
            translationBuilder.add("death.attack.jolted.player", "%1$s was electrocuted by %2$s");
            ...
            translationBuilder.add("death.attack.echoing.player", "%1$s was destroyed whilst fighting by %2$s");
            translationBuilder.add("death.attack.glacioclasm", "%1$s was flash frozen");
            translationBuilder.add("death.attack.glacioclasm.item", "%1$s was flash frozen");
            translationBuilder.add("death.attack.glacioclasm.player", "%1$s was flash frozen by %2$s");
        }
    }
    ...
    public static class AARecipeProvider extends FabricRecipeProvider {
        ...
        public void buildRecipes(Consumer<FinishedRecipe> exporter) {
            ...
            // DAMAGE RELICS
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 1, RelicTypes.DAMAGE)
                    .input(Items.SMOOTH_SANDSTONE, 2)
                    .input(Items.LEATHER)
                    .unlockedBy("obtain_sand", InventoryChangeTrigger.TriggerInstance.hasItems(Items.SAND))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 2, RelicTypes.DAMAGE)
                    .input(Items.STONE, 2)
                    .input(Items.LEATHER)
                    .unlockedBy("obtain_stone", InventoryChangeTrigger.TriggerInstance.hasItems(Items.STONE))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 3, RelicTypes.DAMAGE)
                    .input(Items.DEEPSLATE, 2)
                    .input(Items.LEATHER)
                    .unlockedBy("obtain_deepslate", InventoryChangeTrigger.TriggerInstance.hasItems(Items.DEEPSLATE))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 4, RelicTypes.DAMAGE)
                    .input(Items.QUARTZ, 4)
                    .input(Items.BLAZE_POWDER)
                    .input(Items.LEATHER)
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.QUARTZ))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 5, RelicTypes.DAMAGE)
                    .input(Items.END_STONE, 2)
                    .input(Items.BLAZE_POWDER)
                    .input(Items.LEATHER)
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.END_STONE))
                    .save(exporter);

            // DURABILITY RELICS
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 1, RelicTypes.DURABILITY)
                    .input(AArcanaItems.RESTORINE.get(), 2)
                    .unlockedBy("obtain_restorine", InventoryChangeTrigger.TriggerInstance.hasItems(AArcanaItems.RESTORINE.get()))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 2, RelicTypes.DURABILITY)
                    .input(AArcanaItems.RELIC.get())
                    .input(AArcanaItems.RESTORINE.get(), 3)
                    .input(Items.HONEYCOMB)
                    .unlockedBy("obtain_restorine", InventoryChangeTrigger.TriggerInstance.hasItems(AArcanaItems.RESTORINE.get()))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 3, RelicTypes.DURABILITY)
                    .input(AArcanaItems.RELIC.get())
                    .input(AArcanaItems.RESTORINE.get(), 3)
                    .input(Items.TERRACOTTA)
                    .unlockedBy("obtain_restorine", InventoryChangeTrigger.TriggerInstance.hasItems(AArcanaItems.RESTORINE.get()))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 4, RelicTypes.DURABILITY)
                    .input(AArcanaItems.RELIC.get())
                    .input(Items.DIAMOND)
                    .input(AArcanaItems.RESTORINE.get(), 5)
                    .unlockedBy("obtain_restorine", InventoryChangeTrigger.TriggerInstance.hasItems(AArcanaItems.RESTORINE.get()))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 5, RelicTypes.DURABILITY)
                    .input(AArcanaItems.RELIC.get())
                    .input(AArcanaItems.RELIC.get())
                    .input(Items.DIAMOND)
            ...
            // PROTECTION RELICS
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 1, RelicTypes.PROTECTION)
                    .input(Items.SAND)
                    .input(Items.CLAY_BALL, 2)
                    .input(Items.PAPER)
                    .unlockedBy("obtain_clay", InventoryChangeTrigger.TriggerInstance.hasItems(Items.CLAY_BALL))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 2, RelicTypes.PROTECTION)
                    .input(Items.CLAY_BALL, 4)
                    .input(Items.IRON_NUGGET, 3)
                    .input(Items.PAPER)
                    .unlockedBy("obtain_clay", InventoryChangeTrigger.TriggerInstance.hasItems(Items.CLAY_BALL))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 3, RelicTypes.PROTECTION)
                    .input(Items.IRON_INGOT, 3)
                    .input(Items.COAL, 2)
                    .unlockedBy("obtain_iron", InventoryChangeTrigger.TriggerInstance.hasItems(Items.IRON_INGOT))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 4, RelicTypes.PROTECTION)
                    .input(Items.DIAMOND)
                    ...
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 5, RelicTypes.PROTECTION)
                    .input(Items.GOLD_INGOT)
                    .input(Items.NETHERITE_SCRAP)
                    .unlockedBy("obtain_netherite", InventoryChangeTrigger.TriggerInstance.hasItems(Items.NETHERITE_SCRAP))
                    .save(exporter);

            // HASTE RELICS
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 1, RelicTypes.HASTE)
                    .input(Items.BEEF, 2)
                    .input(Items.PORKCHOP, 2)
                    .input(Items.GLASS_BOTTLE)
                    .unlockedBy("obtain_beef", InventoryChangeTrigger.TriggerInstance.hasItems(Items.BEEF))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 2, RelicTypes.HASTE)
                    .input(Items.HONEYCOMB, 2)
                    .input(Items.GOLD_NUGGET, 2)
                    .input(Items.GLASS_BOTTLE)
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.BEETROOT_SEEDS))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 3, RelicTypes.HASTE)
                    .input(Items.BEETROOT_SEEDS, 2)
                    .input(Items.GOLD_NUGGET, 2)
                    .input(Items.GLASS_BOTTLE)
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.TORCHFLOWER_SEEDS))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 4, RelicTypes.HASTE)
                    .input(Items.TORCHFLOWER_SEEDS, 2)
                    .input(Items.GOLD_INGOT, 2)
                    .input(Items.GLASS_BOTTLE)
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.GOLD_INGOT))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 5, RelicTypes.HASTE)
                    .input(Items.WARPED_ROOTS, 2)
                    .input(Items.BLAZE_POWDER)
                    .input(Items.GOLD_INGOT)
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.WARPED_ROOTS))
                    .save(exporter);

            // ENCHANTMENT CAPACITY RELICS
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 1, RelicTypes.ENCHANTMENT_CAPACITY)
                    .input(Items.LAPIS_LAZULI)
                    .input(Items.AMETHYST_SHARD)
                    .unlockedBy("obtain_amethyst", InventoryChangeTrigger.TriggerInstance.hasItems(Items.AMETHYST_SHARD))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 2, RelicTypes.ENCHANTMENT_CAPACITY)
                    .input(Items.AMETHYST_SHARD)
                    .input(Items.LAPIS_LAZULI, 3)
                    .input(Items.GOLD_NUGGET, 2)
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.AMETHYST_SHARD))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 3, RelicTypes.ENCHANTMENT_CAPACITY)
                    .input(Items.AMETHYST_SHARD)
                    .input(AArcanaItems.ENCHANTED_SCRAP.get(), 5)
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.AMETHYST_SHARD))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 4, RelicTypes.ENCHANTMENT_CAPACITY)
                    .input(Items.AMETHYST_SHARD)
                    .input(Items.DIAMOND)
                    ...
                    .unlockedBy("obtain_relic", InventoryChangeTrigger.TriggerInstance.hasItems(Items.AMETHYST_SHARD))
                    .save(exporter);
            RelicRecipeJsonBuilder.create(RecipeCategory.COMBAT, 5, RelicTypes.ENCHANTMENT_CAPACITY)
                    .input(Items.AMETHYST_SHARD)
                    .input(Items.DIAMOND)
            ...
            exporter.accept(new EnchantmentRecipeProvider(AArcanaEnchantments.ALCHEMISTS_HEART.get())
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            ...
                            IngredientStack.of(Items.GLISTERING_MELON_SLICE, 3),
                            3)));
            ...
            exporter.accept(new EnchantmentRecipeProvider(AArcanaEnchantments.BLAZEBOLT.get())
                    ...
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            ...
                            IngredientStack.of(Items.QUARTZ, 4),
                            IngredientStack.of(Items.MAGMA_CREAM),
                            6))
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 2),
            ...
            exporter.accept(new EnchantmentRecipeProvider(AArcanaEnchantments.MIASMA.get())
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 12),
                            IngredientStack.of(Items.DRAGON_BREATH, 2),
            ...
            exporter.accept(new EnchantmentRecipeProvider(AArcanaEnchantments.NETHER_HEART.get())
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 12),
                            IngredientStack.of(AArcanaTags.Items.HEARTS),
                            IngredientStack.of(Items.NETHERITE_SCRAP),
                            6)));
            ...
            exporter.accept(new EnchantmentRecipeProvider(AArcanaEnchantments.REPEATING.get())
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 3),
                            IngredientStack.of(Items.PITCHER_PLANT),
                            IngredientStack.of(Items.TRIPWIRE_HOOK),
                            4))
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 2),
                            IngredientStack.of(Items.PITCHER_PLANT),
                            IngredientStack.of(Items.REDSTONE),
                            4)));
            ...
            exporter.accept(new EnchantmentRecipeProvider(AArcanaEnchantments.STORM_HEART.get())
                    .level(new  EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 12),
                            IngredientStack.of(AArcanaTags.Items.HEARTS),
                            IngredientStack.of(Items.LIGHTNING_ROD, 2),
                            6)));
            ...
            exporter.accept(new EnchantmentRecipeProvider(Enchantments.BLOCK_FORTUNE)
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(Items.LAPIS_LAZULI, 3),
                            IngredientStack.of(Items.COPPER_INGOT, 3),
                            IngredientStack.of(Items.IRON_INGOT, 2),
                            3))
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 3),
                            IngredientStack.of(Items.QUARTZ, 4),
            ...
            exporter.accept(new EnchantmentRecipeProvider(Enchantments.FROST_WALKER)
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(Items.LAPIS_LAZULI, 3),
                            IngredientStack.of(Items.ICE, 2),
                            null,
                            3))
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(Items.LAPIS_LAZULI, 3),
                            IngredientStack.of(Items.BLUE_ICE, 2),
                            null,
                            3)));
            ...
            exporter.accept(new EnchantmentRecipeProvider(Enchantments.RIPTIDE)
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 3),
                            IngredientStack.of(Items.NAUTILUS_SHELL),
                            null,
                            3))
                    .level(new EnchantmentRecipeProvider.EnchantmentLevelRecipeProvider(
                            IngredientStack.of(AArcanaItems.ENCHANTED_SCRAP.get(), 3),
